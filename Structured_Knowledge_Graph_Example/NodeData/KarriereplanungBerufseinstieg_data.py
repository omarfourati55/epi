TITEL = "Karriereplanung und Berufseinstieg für Informatikstudierende"

CONTENT = (
    "Karriereplanung und Berufseinstieg sind entscheidende Phasen für Informatikstudierende. Eine strategische Vorbereitung und gezielte Maßnahmen sind unerlässlich, um in der dynamischen IT-Branche erfolgreich zu sein. \n\n"

    "# Frühzeitige Karriereplanung \n"
    "Bereits zu Beginn des Studiums sollten Studierende ihre Karriereziele definieren und einen Plan entwickeln. Dies umfasst die Bewertung eigener Interessen und Stärken, das Erkunden verschiedener Karrierewege in der Informatik und die Identifizierung benötigter Kompetenzen. \n\n"
    ...
    "Gründliche Vorbereitung auf Bewerbungsgespräche, einschließlich der Formulierung von Antworten auf gängige Interviewfragen und der Darstellung eigener Projekte, erhöht die Chancen auf Erfolg. \n\n"
