...
from Structured_Knowledge_Graph_Example.NodeData import (StudienRichtungenInDerInformatik_data as St,
                                                         ...
                                                         BalancierenTheoriePraxis_data as BTP)


class StudienRichtungTree:
    def __init__(self, graph: Graph):
        self.balancieren_theorie_praxis_node = None
    ...
    def build_graph(self, graph):
        ...
        self.balancieren_theorie_praxis_node = Node(BTP.CONTENT, BTP.TITEL)
        ...
        self.studien_richtung_node.connect(self.balancieren_theorie_praxis_node)
        ...
        graph.add_new_node_to_graph(self.balancieren_theorie_praxis_node)
